            ...
            <header className="border-b border-zinc-800 p-4 flex items-center justify-between bg-zinc-900/30">
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex flex-col">
                        ...
                        <span className={`text-sm font-bold flex items-center gap-2 ${timeRemeanding != null && timeRemeanding < 60 ? "text-red-500" : "text-amber-500"}`}>
                                {timeRemeanding !== null ? formatTimeRemaining(timeRemeanding) : "--:--"}
                        </span>
                    </div>
                </div>
                ...
                {messages?.messages.length === 0 && (
                    <div className="flex items-center justify-center h-full">
                        <p className="text-zinc-600 text-sm font-mono">
                            No messages yet, star the conversation.
                        </p>
                    </div>
                )}
